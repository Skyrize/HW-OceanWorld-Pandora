...
Shader "FastWaterLowPoly/WaterHDRP"
{
	Properties
	{
		...
		_LowPolyToFlat("LowPolyToFlat", Range( 0 , 1)) = 0.8
		[ASEEnd][Toggle]_WavesInXYZ("WavesInXYZ", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float lerpResult100 = lerp( 1.0 , ase_worldPos.y , _WavesInXYZ);
				float mulTime43 = _TimeParameters.x * _Speed;
				float4 appendResult51 = (float4(0.0 , ( SAMPLE_TEXTURE2D_LOD( _Noise, sampler_Noise, ( ( (ase_worldPos).xz * _ScaleNoise * lerpResult100 ) + mulTime43 ), 0.0 ).r * _NoiseIntensity ) , 0.0 , 0.0));
						...
						)
			{
				...
				float3 lerpResult95 = lerp( normalizeResult93 , normalWS , _LowPolyToFlat);
				...
				float lerpResult85 = lerp( distanceDepth28 , (0.5 + (distanceDepth28 - -1.0) * (1.0 - 0.5) / (1.0 - -1.0)) , _DepthRange);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 lerpResult95 = lerp( normalizeResult93 , ase_worldNormal , _LowPolyToFlat);
				float lerpResult17 = lerp( distanceDepth13 , ( distanceDepth13 * ( 1.0 - (lerpResult95).y ) ) , 0.998);
...
/*ASEBEGIN
Version=18500
0;0;1920;1019;-416.0883;-864.3246;1;True;True
Node;AmplifyShaderEditor.WorldPosInputsNode;45;694.0103,1361.929;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;99;925.3198,1520.356;Inherit;False;Property;_WavesInXYZ;WavesInXYZ;15;1;[Toggle];Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;100;1200.32,1386.356;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;967.704,1756.557;Float;False;Property;_Speed;Speed;11;0;Create;True;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;1106.892,1639.505;Float;False;Property;_ScaleNoise;ScaleNoise;13;0;Create;True;0;0;False;0;False;0;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;54;1141.605,1214.694;Inherit;False;True;False;True;True;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;43;1145.704,1744.557;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;42;1328.067,1034.249;Float;True;Property;_Noise;Noise;10;0;Create;True;0;0;False;0;False;None;eaa1c5562af66424092dc5b1f37208e9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;50;2246.665,1406.527;Float;False;Property;_NoiseIntensity;NoiseIntensity;12;0;Create;True;0;0;False;0;False;0;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;92;2802.562,489.8638;Inherit;False;Property;_LowPolyToFlat;LowPolyToFlat;14;0;Create;True;0;0;False;0;False;0.8;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-1900.536,1169.134;Float;False;Property;_Depth;Depth;4;0;Create;True;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-338.7028,135.0336;Float;False;Property;_SizeFoam;SizeFoam;7;0;Create;True;0;0;False;0;False;2;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;84;-1809.374,541.2766;Inherit;False;Property;_DepthRange;DepthRange;5;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-800.91,1145.026;Float;False;Property;_OpasityIntensity;OpasityIntensity;6;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;306.5998,787.0221;Float;False;Property;_ColorFoam;Color Foam;3;0;Create;True;0;0;False;0;False;0,0,0,0;1,0.9931185,0.86,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;11;-653.0463,617.0334;Float;False;Property;_Colorwater;Color water;0;0;Create;True;0;0;False;0;False;0,0,0,0;0.2316039,0.5137584,0.5607843,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;31;-575.4737,369.9068;Float;False;Property;_ColorDepth;Color Depth;2;0;Create;True;0;0;False;0;False;0,0,0,0;0.04705877,0.1260223,0.1607842,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;86;-1168.124,406.9674;Float;False;Property;_Color0;Color 0;1;0;Create;True;0;0;False;0;False;0,0,0,0;0.1078,0.3022536,0.35,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;24;2637.187,812.5731;Float;False;Property;_Specular;Specular;9;0;Create;True;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;2644.094,907.2694;Float;False;Property;_Gloss;Gloss;8;0;Create;True;0;0;False;0;False;0.9;0.934;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=55B4EAB81B55CBCE20659EAC20074EC6ED7F7FA5